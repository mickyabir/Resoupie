...
struct CookBookApp: App {
    var body: some Scene {
        WindowGroup {
            ...
            let boba_recipe = Recipe(id: UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09e")!, image: "simple_milk_tea", name: "Simple Milk Tea", author: "Micky Abir", rating: 4.5, ingredients: ingredients_boba, steps: steps_boba)
            ...
            let coffee_recipe = Recipe(id: UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09f")!, image: "flat_white", name: "Flat White", author: "Kane Statton", rating: 5, ingredients: ingredients_coffee, steps: steps_coffee)
